...
export default function OrdemTransbordo() {
  ...
  const loadData = useCallback(async ({ silent = false } = {}) => {
    ...
    try {
      const [trans, prods, cliens, ents, isos, vascs, vals] = await Promise.all([
      ...
      setValidacoesPendentes(
        (vals || []).filter((v) => v.status === "pendente")
      );
    } catch (err) {
  ...
  }, [produtos, clienteId, clienteNome]);
  ...
  const handleSaveTransbordo = async (data) => {
    ...
    try {
      ...
      await criarValidacao({
        tipo: isGranel ? "granel_transbordo" : "transbordo",
        origemTipo: isGranel
          ? "granel"
  ...
  const headerReady = Boolean(dataOp && clienteNome && produtoId);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <SearchableSelect
                  ...
                  placeholder={t("painel.operacional.ordemTransbordo.placeholders.client")}
              ...
              <div className="space-y-1.5 sm:col-span-2 lg:col-span-1">
                ...
                <SearchableSelect
                  ...
                  getOptionLabel={(p) => `${p.codigo || ""} - ${p.produto || p.nome || ""}`}
            ...
            <div className="flex justify-end">
              <Can permission={`${PERM}.create`}>
                <Button
                  ...
                  disabled={goingToTransbordo || !origemTipo}
