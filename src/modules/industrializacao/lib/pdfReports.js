...
} from '@industrializacao/lib/productionFiscalShare';
import { materialsFromOriginRows } from '@industrializacao/lib/containerOrigins';
import {
...
export function generateStockPDF(item, consumption, movements) {
  ...
  y = addInfoGrid(doc, y, [
    ...
    [t('pdf.fields.invoice'), item.nota_fiscal || '-'],
