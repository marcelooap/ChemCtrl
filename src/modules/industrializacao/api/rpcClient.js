...
import { classifyRpc } from '@industrializacao/lib/rateLimitConfig';
import { HttpError, parseRetryAfterHeader, parseRetryAfterFromBody } from '@industrializacao/lib/HttpError';
...
export const getSessionId = () => safeLocalStorage.getItem('chemctrl_session_id') || '';
export const setSessionId = (id) => {
  if (id) safeLocalStorage.setItem('chemctrl_session_id', id);
  else safeLocalStorage.removeItem('chemctrl_session_id');
};
export const clearSessionId = () => safeLocalStorage.removeItem('chemctrl_session_id');
