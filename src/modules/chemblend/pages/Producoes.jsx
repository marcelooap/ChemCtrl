...
import InvoiceToggle from '@chemblend/components/productions/InvoiceToggle';
import { generateProductionPDF, generateProductionTanksPDF, generateProductionOriginsPDF, generateProductionOpFiscalPDF } from '@chemblend/lib/pdfReports';
import QrCodeDialog from '@chemblend/components/productions/QrCodeDialog';
import ProductionViewDialog from '@chemblend/components/production/ProductionViewDialog';
import FractionalBadge from '@chemblend/components/production/FractionalBadge';
import { isComplementPending } from '@chemblend/lib/fractionalSupply';
import { parseArr, containersOfProductionLot } from '@chemblend/lib/productionViewUtils';
import { packagingRowsForProduction } from '@chemblend/lib/containerOrigins';
...
import { RBAC_ADMIN_SLUG } from '@chemblend/lib/rbac/permissionCatalog';
import { syncOrderFromProductions } from '@chemblend/lib/orderProductionStatus';
