...
import { generateRecipePDF } from '@chemblend/lib/pdfReports';
import Combobox from '@shared/components/ui/combobox';
import SimuladorReceita from '@chemblend/components/receitas/SimuladorReceita';
import RecipeFdsSection, { RecipeFdsViewSection } from '@chemblend/components/receitas/RecipeFdsSection';
import ConfirmDialog from '@chemblend/components/ConfirmDialog';
import { fmtNumber, fmtCurrency, fmtVolume } from '@/i18n/formatters';
import { canManageRecipeFds, canRemoveRecipeFds, canViewRecipeFds, hasPermission } from '@chemblend/lib/permissions';
import { calcPriceWithoutTax } from '@chemblend/lib/recipePricing';
import { uploadRecipeDocument, deleteRecipeDocument, copyRecipeDocument, getRecipeDocStorageUrl, validatePdfFile, DOC_TYPES } from '@chemblend/api/storage';
